            ...
            <div className="basic-info-section">
              <table className="basic-info-table">
                <tbody>
                  ...
                  <tr>
                    <td className="label-cell name no-right-border" colSpan="7">
                      氏&emsp;&emsp;名
                      <br />
            ...
            <div className="history-section">
              <table className="history-table">
                <tbody>
                  ...
                  {/* 打工經歷內容 */}
                  {Array.from({ length: 5 }).map((_, index) => {
                    const dateStr = experience.partTimeJobs[index]?.date || "";
                    const [year, month] = dateStr
                      ? dateStr.split("-")
                      : ["", ""];
                    return (
                ...
                <tbody>
                  <tr>
                    <td className="label-cell" colSpan="6">
                      勤務可能期間： 西暦 
                      {otherInfo.workStartDate ? new Date(otherInfo.workStartDate).getFullYear() : ""}年
                      {otherInfo.workStartDate ? new Date(otherInfo.workStartDate).getMonth() + 1 : ""}月
                      {otherInfo.workStartDate ? new Date(otherInfo.workStartDate).getDate() : ""}日 から{" "}
                      {otherInfo.workEndDate ? new Date(otherInfo.workEndDate).getFullYear() : ""}年
                      {otherInfo.workEndDate ? new Date(otherInfo.workEndDate).getMonth() + 1 : ""}月
                      {otherInfo.workEndDate ? new Date(otherInfo.workEndDate).getDate() : ""}日 まで {otherInfo.workConditions}
                    </td>
                  </tr>
                  <tr>
                ...
                <tbody>
                  <tr>
                    <td className="label-cell" colSpan="4">
                      国内連絡人&emsp;続柄&emsp;{emergencyContact.relationship}
                    </td>
                  </tr>
                  <tr>
